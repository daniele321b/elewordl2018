        ...
        <%} %>
	       ...
	       <div class="account-bottom">
				<div class="col-md-6 account-left">
					<form name="form-reg" action="PswLost" method="post" onsubmit="return validateModifica(this);">
					...
					<div class="address">
						<span>RE-INSERISCI NUOVA PASSWORD</span>
						<input type="password" name="repassword">
					</div>
					<div class="address new">
						<input type="submit" name="reg-submit" value="SALVA">
					</div>
					</form>
				</div>
				 </div>
